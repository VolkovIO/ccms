...
import com.example.ccms.communicationcase.application.command.CloseCommunicationCaseCommand;
import com.example.ccms.communicationcase.application.command.CloseCommunicationCaseUseCase;
import com.example.ccms.communicationcase.application.command.OpenCommunicationCaseCommand;
import com.example.ccms.communicationcase.application.command.OpenCommunicationCaseUseCase;
...
import com.example.ccms.communicationcase.application.command.RegisterCallAttemptCommand;
import com.example.ccms.communicationcase.application.command.RegisterCallAttemptUseCase;
import com.example.ccms.communicationcase.application.command.SendOutgoingMessageCommand;
import com.example.ccms.communicationcase.application.command.SendOutgoingMessageUseCase;
import com.example.ccms.communicationcase.application.query.CommunicationCaseDetails;
import com.example.ccms.communicationcase.application.query.CommunicationCaseListItem;
import com.example.ccms.communicationcase.application.query.GetCommunicationCaseByIdQuery;
import com.example.ccms.communicationcase.application.query.GetCommunicationCaseByIdUseCase;
import com.example.ccms.communicationcase.application.query.SearchCommunicationCasesQuery;
import com.example.ccms.communicationcase.application.query.SearchCommunicationCasesUseCase;
